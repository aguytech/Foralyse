...
sudo chown -R libvirt-qemu:libvirt-qemu ${_PATH_SHARE}
...
echo "Target path: ${_PATH_SHARE}"
_echoyb "\nAnd add fmode and dmode by modifying XML settings options in virt-manager:"
echo -e '<filesystem type="mount" accessmode="mapped" '${yellow}'fmode="0660" dmode="0770"'${cclear}'>
