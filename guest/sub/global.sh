...
sudo apt install -y binutils-common bsdmainutils curl debconf-utils exfat-utils genisoimage git gnupg2 gparted hfsprogs htop kpartx lnav most net-tools p7zip-full p7zip-rar pv rar sysstat testdisk tmux tree unrar vim xsysinfo # openssh-server
